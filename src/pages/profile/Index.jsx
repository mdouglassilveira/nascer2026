...
import { Save, Loader2, User, Phone, Mail, Pencil } from 'lucide-react'
  ...
  return (
    <div className="px-4 pt-4 lg:px-0">
      ...
      <div className="flex flex-col items-center mb-6">
        <div className="w-20 h-20 rounded-full bg-linear-to-br from-primary to-primary-light flex items-center justify-center shadow-lg shadow-primary/25">
      ...
      {editing ? (
        ...
        >
          ...
          <InputField label="Nome completo" value={form.full_name} onChange={v => setForm(f => ({ ...f, full_name: v }))} />
          <InputField label="Telefone" value={form.phone} type="tel" onChange={v => setForm(f => ({ ...f, phone: v }))} />
          <div>
